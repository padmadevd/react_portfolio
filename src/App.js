...
let _useStyle = createUseStyles({
  "@global": {
    ...
    "@font-face": [
      {
        fontFamily: "ubuntu",
        src: `url('${process.env.PUBLIC_URL}/fonts/ubuntu/Ubuntu-Regular.ttf') format('truetype')`,
        fontWeight: "normal",
        fontStyle: "normal",
      },
      {
        fontFamily: "ubuntu",
        src: `url('${process.env.PUBLIC_URL}/fonts/ubuntu/Ubuntu-Bold.ttf') format('truetype')`,
        fontWeight: "bold",
        fontStyle: "normal",
      },
      {
        fontFamily: "ubuntu",
        src: `url('${process.env.PUBLIC_URL}/fonts/ubuntu/Ubuntu-Italic.ttf) format('truetype')`,
        fontWeight: "normal",
        fontStyle: "italic",
      },
    ],
